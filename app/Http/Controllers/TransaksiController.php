...
class TransaksiController extends Controller
{
    public function index()
    {
        ...
        return view('transaksi.mainTransaksi', ['breadcrumb' => $breadcrumb, 'page' => $page, 'penjualan' => $penjualan, 'user' => $user, 'activeMenu' => $activeMenu]);
    }
    ...
    public function create_ajax()
    {
        ...
        return view('transaksi.create_ajax')->with('user', $user);
    }
    ...
    public function show_ajax(string $id) {
        ...
        return view('transaksi.detail_ajax', ['penjualan' => $penjualan, 'user' => $user, 'detail' => $detail]);
    }
    ...
    public function edit_ajax(string $id)
    {
        ...
        return view('transaksi.edit_ajax', ['penjualan' => $penjualan, 'user' => $user]);
    }
